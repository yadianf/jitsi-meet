...
import { getCurrentLayout, LAYOUTS } from '../../../large-video';
import { requestRemoteControl, stopController } from '../../../remote-control';

import MuteEveryoneElseButton from './MuteEveryoneElseButton';
import { REMOTE_CONTROL_MENU_STATES } from './RemoteVideoMenuButton';
    ...
    _renderRemoteVideoMenu() {
        ...
        if (_remoteControlState) {
            ...
            if (_remoteControlState === REMOTE_CONTROL_MENU_STATES.STARTED) {
                onRemoteControlToggle = () => this.props.dispatch(stopController());
            } else if (_remoteControlState === REMOTE_CONTROL_MENU_STATES.NOT_STARTED) {
                onRemoteControlToggle = () => this.props.dispatch(requestRemoteControl(participantID));
            }
